<template>
    <div>
        ...
        <div >
            <div class="titleBg">操作记录现场还原</div>
            <div class="block">
        ...
        <el-dialog title="操作现场" width="60%" style="text-align: center;" :visible.sync="case_detail_dialog" @close="beforeClose">
          <video id="videoId" src="../../../static/img/zhanshi.mp4" controls="controls">
                    ...
                    <div>
                      <el-row>
                        <!-- <el-col :span="12"><div class="grid-content">
                           <el-button size="mini" @click="applyNow(v)" type="warning">查看视频</el-button>
                        </div></el-col> -->
                        <el-col :span="12"><div class="grid-content">
